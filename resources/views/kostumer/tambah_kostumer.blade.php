...
<body>
    ...
    <div class="container">
    <h2 class="font-weight-bold text-center">Tambah Kostumer</h2>
        <div class="col-md-6 offset-md-3 mt-5">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('tambahKostumerAksi') }}" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kostumer_nama" class="form-control" placeholder="Masukkan nama kostumer" value="{{ old('kostumer_nama') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kostumer_alamat" class="form-control" placeholder="Masukkan alamat kostumer" value="{{ old('kostumer_alamat') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kostumer_hp" class="form-control" placeholder="Masukkan no. hp kostumer" value="{{ old('kostumer_hp') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kostumer_ktp" class="form-control" placeholder="Masukkan no. ktp kostumer" value="{{ old('kostumer_ktp') }}">
